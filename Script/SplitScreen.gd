...
@onready var left_view: SubViewport = $HBoxContainer/LeftSide/CoderView
@onready var right_view: SubViewport = $HBoxContainer/RightSide/AnalystView

@onready var left_cam: Camera2D = $HBoxContainer/LeftSide/CoderView/CoderCam
@onready var right_cam: Camera2D = $HBoxContainer/RightSide/AnalystView/AnalystCam

@onready var left_player: Node2D = $HBoxContainer/LeftSide/CoderView/Room1/CoderPlayer
@onready var right_player: Node2D = $HBoxContainer/RightSide/AnalystView/Room2/AnalystPlayer
